...
{
    public class ControllerDis
    {
        static ControllerDis singleton;
        public static ControllerDis Singleton
        {
            get
            {
                return singleton;
        ...
        static ControllerDis()
        {
            singleton = new ControllerDis();
        }
        private ControllerDis()
        {
